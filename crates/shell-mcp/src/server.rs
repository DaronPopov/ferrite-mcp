...
impl McpServer {
    ...
    fn call_tool(&self, name: &str, args: &Value) -> Result<ToolResult, String> {
        match name {
            ...
            "graphics_list_runtime_targets" => tools::graphics::graphics_list_runtime_targets(args),
            "graphics_plan_runtime_export" => tools::graphics::graphics_plan_runtime_export(args),
            "graphics_write_runtime_bundle" => tools::graphics::graphics_write_runtime_bundle(args),
            "graphics_scene_list_nodes" => tools::graphics::graphics_scene_list_nodes(args),
            "graphics_scene_set_node_field" => tools::graphics::graphics_scene_set_node_field(args),
            "graphics_scene_patch_node" => tools::graphics::graphics_scene_patch_node(args),
            "graphics_scene_add_node" => tools::graphics::graphics_scene_add_node(args),
            "graphics_scene_remove_node" => tools::graphics::graphics_scene_remove_node(args),
            "graphics_scene_focus_node" => tools::graphics::graphics_scene_focus_node(args),
            // State
