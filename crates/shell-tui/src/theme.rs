...
pub const CREAM: Color = Color::Rgb {
    r: 245,
    g: 240,
    b: 232,
};
...
pub const DUST: Color = Color::Rgb {
    r: 168,
    g: 152,
    b: 128,
};
...
pub const SAND: Color = Color::Rgb {
    r: 139,
    g: 115,
    b: 85,
};
...
/// Success / ok                      #5C8A3C
pub const SAGE: Color = Color::Rgb {
    r: 92,
    g: 138,
    b: 60,
};
...
/// Error                             #A0522D
pub const SIENNA: Color = Color::Rgb {
    r: 160,
    g: 82,
    b: 45,
};
...
/// Warning                           #B8860B
pub const OCHRE: Color = Color::Rgb {
    r: 184,
    g: 134,
    b: 11,
};
