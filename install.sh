...
if [ -f "$AUTOSTART_SRC" ]; then
    ...
    inf "Config  : ~/.config/ferrite/gmail.conf (GMAIL_USER, GMAIL_APP_PASSWORD, GMAIL_TO)"
...
# ── Ecosystem ──────────────────────────────────────────────────────────────────
echo ""
bold "ferrite ecosystem"
inf "ferrite-mcp is one product in the ferrite GPU stack."
inf "Install companion products for full capability:"
inf ""
inf "  LLM runtime  : curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite-llm/main/install.sh | sh"
inf "  CUDA substrate: curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite-os/main/install.sh | sh"
inf "  Graphics     : curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite-graphics/main/install.sh | sh"
inf ""
inf "  Full stack (auto-detect platform):"
inf "    curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite/main/install.sh | sh"
inf ""
inf "  Specific profile:"
inf "    curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite/main/install.sh | sh -s -- --profile workstation-full"
inf "    curl -fsSL https://raw.githubusercontent.com/DaronPopov/ferrite/main/install.sh | sh -s -- --profile workstation-nvidia"
